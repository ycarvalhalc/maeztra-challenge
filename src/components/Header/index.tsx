  ...
  return (
    <header className="header">
      ...
      <div className="header__main">
        ...
        <a href="/"><img className="header__logo" src="/logo-maeztra-novo.png.png" alt="Logo" /></a>
        
        <Search />

        <div className="header__mainRight">
          <a href="/" className="header__mainRightGroup header__mainRightGroup--user">
            <img className="header__mainRightGroupIcon" src="/icon_user.png" alt="Ícone minha conta" />
          ...
          <a href="/" className="header__mainRightGroup header__mainRightGroup--wishlist">
            <img className="header__mainRightGroupIcon" src="/icon_heart.png" alt="Ícone wishlit" />
            <span className="header__mainRightGroupText">Wishlist</span>
          </a>

          <div className="header__mainRightGroup header__mainRightGroup--cart">
            <img className="header__mainRightGroupIcon" src="/minicart.v2.png" alt="Ícone carrinho" />
